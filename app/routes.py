...
def week_dates(start_date):
    """Return the Sunday-to-Saturday week containing start_date."""
    sunday = start_date - timedelta(days=(start_date.weekday() + 1) % 7)
...
def index():
    ...
    tasks = (
        Task.query
        .filter(Task.task_date.in_(days))
